        ...
        <div className="home">
            <section>
                <header className="header-banner">
                    <img src="/images/hotelbg.png" alt="Hotel" className="header-image" />
                    <div className="overlay"></div>
                    <div className="animated-texts overlay-content">
                        <h1>Welcome to <span className="phegon-color">The Nexus Royal</span></h1> <br />
            ...
            <h2 className="home-services">Services at <span className="phegon-color">The Nexus Royal</span></h2>

            {/* SERVICES SECTION */}
            <section className="service-section">
                <div className="service-card">
                    <img src="/images/ac-home.png" alt="Air Conditioning" />
                ...
                <div className="service-card">
                    <img src="/images/barh.png" alt="Mini Bar" />
                    <div className="service-details">
